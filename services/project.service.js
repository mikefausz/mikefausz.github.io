  ...
  .service('ProjectService', function($http, $q) {
    var projects = [
      ...
      },
      {
        ...
        description: "Drivers can see view and accept open requests, as well as requests they've already accepted.",
        elab: "Users can post multiple requests, view their open and pending requests, and complete requests upon delivery.",
        tech: [4, 2],
...

      {
        ...
        description: "It's action-packed with all sorts of animations and a pure CSS slideshow.",
      ...
      },
      {
        ...
        description: "You can pick your hunter and your weapon and get to huntin'.",
        elab: "It can take a while for critters to show up, so you can drink beer to pass the time. Drink too many and you might miss your shot.",
        tech: [4, 7],
        url: '/big-buck-hunter',
